    ...
    <footer className="bg-gradient-to-b from-gray-900 via-slate-900 to-black text-white pt-16 pb-8 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* Company Info */}
          <div>
            <motion.div className="flex items-center gap-3 mb-4" whileHover={{ scale: 1.05 }}>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg mb-4 bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
              Quick Links
            </h3>
            <ul className="space-y-3">
              <li>
                <button
                  ...
                  className="text-gray-400 hover:text-white hover:translate-x-1 transition-all inline-block cursor-pointer"
                >
                  Home
                </button>
              </li>
          ...
          {/* Services */}
          <div>
            <h3 className="text-lg mb-4 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
              Our Services
            </h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg mb-4 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
              Contact Us
            </h3>
            <div className="space-y-3 text-gray-400">
              <a
                href="mailto:info@fajrsoft.ae"
                className="flex items-start gap-3 hover:text-white transition-colors cursor-pointer"
              >
