      ...
      <section className="py-20">
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl md:text-4xl mb-4">Visual Showcase</h2>
            <p className="text-xl text-gray-600">{caseStudy.showcase.description}</p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {caseStudy.showcase.images.map((image, index) => (
              <motion.div
                key={index}
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {relatedProjects.map((project, index) => (
                <motion.div
                  ...
                  whileHover={{ y: -10 }}
                >
                  <Link to={`/case-study/${project.slug}`} onClick={() => window.scrollTo(0, 0)}>
